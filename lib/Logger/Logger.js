...
class Logger {
  ...
  constructor(options = {}) {
    ...
    if (options.argv && options.argv.interactive !== undefined) {
      this.interactive = !!options.argv.interactive;
    }
  ...
  get isInteractive() {
    ...
    return this.stream.isTTY && typeof process.stdin.setRawMode === 'function' || false;
  }
